...
%basepath = 'C:\Users\WilsonLab\Desktop\Sasha\lexAOP_Chrimson--gcamp6f----lexA_Or83b--nsyb_2015_03_25_fly2\';
basepath = 'C:\Users\WilsonLab\Desktop\Sasha\fly_health_81_07232015\';
cd(basepath)

NUM = 2;
num_str = [ num2str( NUM ) '_'];
% trial_types = { 'both_odor', 'left_odor', 'right_odor', 'both_air', 'left_air', 'right_air' };
trial_types = { ['Simple_Odor_' num_str]};
